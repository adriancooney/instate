...
/***/ function(module, exports, __webpack_require__) {
	...
	var _components = __webpack_require__(/*! ./components */ 163);
	...
	function App() {
	    return _react2.default.createElement(
	        "div",
	        null,
	        _react2.default.createElement(_components.TodoList, null),
	        _react2.default.createElement(_components.AddTodo, null),
	...
	_.state.subscribe(function (path, value, state) {
...
/* 159 */
/*!*********************************************************!*\
  !*** /Users/adrian/Dropbox/Projects/store/src/State.js ***!
  \*********************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _debug = __webpack_require__(/*! debug */ 160);
	...
	var debugState = (0, _debug2.default)("state");
	var debugComponent = (0, _debug2.default)("state:component");
	...
	var State = function () {
	    ...
	    _createClass(State, [{
	        ...
	        value: function get(path) {
	            ...
	            return path.split(SEPARATOR).reduce(function (parent, prop, i, split) {
	                if (_typeof(parent[prop]) === "object" || i === split.length - 1) return parent[prop];else throw new Error("Unable to get with invalid path '" + path + "'.");
	            }, this.getState());
	        }
	        ...
	        value: function _delete(path) {
	            ...
	            var tree = [SEPARATOR].concat(_toConsumableArray(State.expandTree(path)));
	            var value = this.get(path);
	            var valueKey = path.split(SEPARATOR).pop();
	            var parentPath = tree[tree.length - 2];
	            var parentValue = this.get(parentPath);
	
	            debugState("Deleting '" + path + "' from global state.");
	            this.update(parentPath, Object.keys(parentValue).reduce(function (value, key) {
	        ...
	        value: function update(path, value) {
	            ...
	            var create = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
	            ...
	            path.split(SEPARATOR).reduce(function (parent, prop, i, split) {
	                if (i === split.length - 1) {
	                    var oldValue = parent[prop];
	                    parent[prop] = value;
	                    _this.handleChange(path, value, oldValue);
	                } else {
	                    var propValue = parent[prop];
	                    if (typeof propValue === "undefined" || (typeof propValue === "undefined" ? "undefined" : _typeof(propValue)) !== "object") {
	                        if (!create) throw new Error("Attempting to update an invalid path '" + path + "' on state tree.");
	
	                        if (typeof propValue !== "undefined") throw new Error("Attempting to overwrite value on path '" + path + "' on state tree.");
	        ...
	        key: "subscribe",
	        value: function subscribe(path, listener) {
	            ...
	            this.subscriptions[path] = [].concat(_toConsumableArray(this.subscriptions[path] || []), [listener]);
	        }
	        ...
	        key: "unsubscribe",
	        value: function unsubscribe(path, listener) {
	        ...
	        key: "handleChange",
	        value: function handleChange(path, value, oldValue) {
	            var _this2 = this;
	
	            debugState("State change for key '" + path + "'.", value);
	
	            [SEPARATOR].concat(_toConsumableArray(State.expandTree(path))).forEach(function (key) {
	                debugState("Notifying subscriptions for path '" + key + "'.");
	                var subs = _this2.subscriptions[key];
	
	                if (subs) {
	                    subs.forEach(function (sub) {
	                        return sub.call(null, path, value, oldValue, _this2.getState());
	                    });
	                }
	            });
	        }
	        ...
	        key: "expandTree",
	        value: function expandTree(path) {
	            return path.split(SEPARATOR).reduce(function (paths, segment, i, split) {
	...
	function connect(descriptor) {
	    var targetState = arguments.length <= 1 || arguments[1] === undefined ? state : arguments[1];
	    ...
	    return function (target) {
	        return function (_target) {
	            ...
	            function Provider() {
	                ...
	                var _this3 = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Provider)).call.apply(_Object$getPrototypeO, [this].concat(args)));
	
	                if (!_this3.state) _this3.state = {};
	                return _this3;
	            }
	            ...
	            _createClass(Provider, [{
	                ...
	                value: function componentWillMount() {
	                    ...
	                    debugComponent(_get(Object.getPrototypeOf(Provider.prototype), "constructor", this).name + ":componentWillMount(): Subscribing to keys '" + keys.join("', '") + "' on global state.");
	                    ...
	                    keys.forEach(function (key) {
	                        ...
	                        targetState.subscribe(descriptor[key], subs[key] = function (path, value, state) {
	                            debugComponent(_get(Object.getPrototypeOf(Provider.prototype), "constructor", _this4).name + ": State update on path '" + descriptor[key] + "'. Updating key '" + key + "' on local state.", value);
	
	                            var newState = {};
	                            newState[key] = value;
	                            _this4.setState(newState, null, false);
	                        });
	                    });
	                    ...
	                    if (_get(Object.getPrototypeOf(Provider.prototype), "componentWillMount", this)) _get(Object.getPrototypeOf(Provider.prototype), "componentWillMount", this).call(this);
	                }
	                ...
	                value: function componentWillUnmount() {
	                    if (_get(Object.getPrototypeOf(Provider.prototype), "componentWillUnmount", this)) _get(Object.getPrototypeOf(Provider.prototype), "componentWillUnmount", this).call(this);
	
	                    debugComponent(_get(Object.getPrototypeOf(Provider.prototype), "constructor", this).name + ":componentWillUnmount(): Unsubscribing from keys '" + keys.join("', '") + "' on global state.");
	                    keys.forEach(function (key) {
	                        return targetState.unsubscribe(descriptor[key], subs[key]);
	                    });
	                }
	                ...
	                value: function setState(state, callback) {
	                    ...
	                    var map = arguments.length <= 2 || arguments[2] === undefined ? true : arguments[2];
	
	                    if (map) {
	                        keys.forEach(function (key) {
	                            if (typeof state[key] !== "undefined") {
	                                debugComponent(_get(Object.getPrototypeOf(Provider.prototype), "constructor", _this5).name + ":setState(): Updating global state key '" + key + "' with value:", state[key]);
	                                targetState.update(descriptor[key], state[key]);
	                            }
	                        });
	                    }
	
	                    return _get(Object.getPrototypeOf(Provider.prototype), "setState", this).call(this, state, callback);
	                }
	            }]);
...
/* 160 */
/*!***************************************************************!*\
  !*** /Users/adrian/Dropbox/Projects/store/~/debug/browser.js ***!
  \***************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	exports = module.exports = __webpack_require__(/*! ./debug */ 161);
	exports.log = log;
...
/* 161 */
/*!*************************************************************!*\
  !*** /Users/adrian/Dropbox/Projects/store/~/debug/debug.js ***!
  \*************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	exports.humanize = __webpack_require__(/*! ms */ 162);
...
/* 162 */
/*!**********************************************************!*\
  !*** /Users/adrian/Dropbox/Projects/store/~/ms/index.js ***!
  \**********************************************************/
/***/ function(module, exports) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TodoList = exports.Controls = exports.AddTodo = undefined;
	
	var _AddTodo2 = __webpack_require__(/*! ./AddTodo */ 164);
	
	var _AddTodo3 = _interopRequireDefault(_AddTodo2);
	
	var _Controls2 = __webpack_require__(/*! ./Controls */ 165);
	
	var _Controls3 = _interopRequireDefault(_Controls2);
	
	var _TodoList2 = __webpack_require__(/*! ./TodoList */ 166);
	
	var _TodoList3 = _interopRequireDefault(_TodoList2);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.AddTodo = _AddTodo3.default;
	exports.Controls = _Controls3.default;
	exports.TodoList = _TodoList3.default;
	...
	var AddTodo = function (_Component) {
	    ...
	    _createClass(AddTodo, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement("input", { type: "text", ref: "todo", placeholder: "Remember to.." }),
	        ...
	        value: function onSubmit(event) {
	            ...
	            _.state.update("todos.list", [].concat(_toConsumableArray(_.state.get("todos.list")), [{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controls = (_dec = (0, _.connect)({ filter: "todos.filter" }), _dec(_class = function (_Component) {
	    ...
	    _createClass(Controls, [{
	        ...
	        value: function render() {
	            ...
	            var filters = ["all", "completed"].map(function (filter) {
	                return _react2.default.createElement(
	                    "li",
	                    { key: filter },
	                    _react2.default.createElement(
	                        "a",
	                        { href: "#", onClick: _this2.changeFilter.bind(_this2, filter) },
	                        "" + filter + (filter === _this2.state.filter ? " (current)" : "")
	                    )
	                );
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoList = (_dec = (0, _.connect)({ todos: "todos.list", filter: "todos.filter" }), _dec(_class = function (_Component) {
	    ...
	    _createClass(TodoList, [{
	        ...
	        value: function render() {
	            ...
	            var todos = this.state.todos.filter(function (todo) {
	                return _this2.state.filter === "all" || _this2.state.filter === "completed" && todo.completed;
	            }).map(function (todo, i) {
	                return _react2.default.createElement(
	                    "li",
	                    { key: i },
	                    _react2.default.createElement("input", { type: "checkbox", checked: todo.completed, onChange: _this2.toggle.bind(_this2, i) }),
	                    todo.text
	                );
	            });
	        ...
	        key: "toggle",
	        value: function toggle(index, event) {
	            this.setState({
	                todos: this.state.todos.map(function (todo, i) {
	                    return i === index ? _extends({}, todo, { completed: event.target.checked }) : todo;
	                })
	            });
	        }
	    }]);
